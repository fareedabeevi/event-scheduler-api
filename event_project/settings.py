...
SECRET_KEY = 'django-insecure-i)gh-0o=vp4-y!%-pi83x_4d)8p$ca4h9-yot_-8=8*pbr@ito'
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(minutes=30),  # Adjust the time as needed
...
DATABASES = {
    'default': {
        ...
        'NAME': 'event_schedulerdb',
        'USER': 'postgres',
        'PASSWORD': '2003',  # Ensure this is correct
        'HOST': 'localhost',
        'PORT': '5432',
